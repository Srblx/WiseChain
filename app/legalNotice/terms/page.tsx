  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        ...
        <p>
          <strong>Accès :</strong> L'accès à certains contenus peut nécessiter la création d'un
          compte utilisateur.
        </p>
        <p>
          <strong>Comportement :</strong> Les utilisateurs doivent se
          comporter de manière respectueuse et ne pas utiliser le site pour des
          activités illégales ou nuisibles.
        </p>
        <p>
          <strong>Contenu :</strong> Le contenu du site est protégé par des droits d'auteur. Toute reproduction ou distribution
          non autorisée est interdite.
        </p>
        <h2 className={classNameTitle}>4. Inscription et Compte Utilisateur</h2>
        <p>
          <strong>Informations :</strong> Vous devez fournir des informations exactes et
          complètes lors de votre inscription.
        </p>
        <p>
          <strong>Sécurité :</strong> Vous êtes responsable de la sécurité de votre compte et de la confidentialité de votre mot
          de passe.
        </p>
        ...
        <h2 className={classNameTitle}>7. Protection des Données Personnelles</h2>
        <p>
          <strong>Collecte et Traitement des Données :</strong> Nous collectons et traitons vos données personnelles conformément au Règlement Général sur la Protection des Données (RGPD). Les données collectées incluent, mais ne sont pas limitées à, votre nom, adresse e-mail, et informations de paiement.
        </p>
        <p>
          <strong>Droits des Utilisateurs :</strong> Vous avez le droit d'accéder, de rectifier, de supprimer vos données personnelles, ainsi que le droit à la portabilité de vos données. Pour exercer ces droits, veuillez nous contacter à wisechainnet@gmail.com.
        </p>
        <h2 className={classNameTitle}>8. Utilisation des Cookies</h2>
        <p>
          Nous utilisons des cookies pour améliorer votre expérience sur notre site. Vous pouvez gérer vos préférences en matière de cookies via les paramètres de votre navigateur.
        </p>
