          ...
          text={
            <>
              <p>
                ...
                volatile des crypto-monnaies les rend particulièrement sensibles
                aux fluctuations du marché ainsi qu'aux événements
              ...
              <p>
                ...
                financiers. Les statistiques montrent qu'une grande majorité des
                investisseurs particuliers subissent des pertes en négociant des
                CFD. Avant de vous engager, assurez-vous de maîtriser le
                fonctionnement de ces instruments complexes et d'en accepter les
                risques inhérents.
              </p>
              <br />
              <p>
                Avant de décider de négocier des instruments financiers ou des
                crypto-monnaies, il est essentiel d'être pleinement informé des
                risques et des frais associés aux transactions sur les marchés
                financiers. Examinez attentivement vos objectifs de placement,
                votre niveau d’expérience, votre tolérance pour le risque et
                consultez des professionnels si nécessaire.
              </p>
              <br />
              <p>
                En outre, il est obligatoire de déclarer les gains provenant des
                investissements, y compris ceux réalisés avec des crypto-actifs,
                aux autorités fiscales compétentes. Le non-respect de ces
                obligations peut entraîner des pénalités importantes.
              </p>
              <br />
              <p>
                WiseChain peut fournir des commentaires d’ordre général qui ne
                constituent pas des conseils en investissement et ne doivent pas
                être interprétés comme tels. WiseChain décline toute
                responsabilité pour les erreurs, investissements inopportuns,
                inexactitudes ou omissions, et ne garantit pas l’exactitude ou
                la complétude des informations, textes, graphiques, liens ou
                autres éléments contenus dans l'application.
              </p>
            </>
          }
          choice="Retour"
