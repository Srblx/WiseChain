    ...
    <>
      <div className='bg-backgroundTransparent flex justify-center items-center p-6 border-y-2 border-white mt-20'>
        <p className='text-center text-sm'>
          ...
          engager, assurez-vous de maîtriser le fonctionnement de ces
          instruments complexes et d&#39;en accepter les risques inhérents.
          <br />
          <br />  Avant de décider de négocier des instruments financiers ou des
          crypto-monnaies, vous devez être pleinement informé des risques et des
          frais associés aux transactions sur les marchés financiers, examiner
          attentivement vos objectifs de placement, votre niveau d’expérience et
          votre tolérance pour le risque et faire appel à des professionnels si
          nécessaire. 
          <br />
          <br />
          WiseChain peut être amené à produire des commentaires
          d’ordre général qui ne constituent pas des conseils en investissement
          et ne doivent pas être interprétés comme tels. WIseChain décline toute
      ...
      <footer className='footer p-10 mt-6 text-white'>
