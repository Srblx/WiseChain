export const footerItems = [
  ...
  },
  {
    title: 'Legal',
    links: [
      { label: 'FAQ', path: '/legalNotice/faq' },
      { label: 'À Propos', path: '/legalNotice/about' },
      { label: "Condition d'utilisation", path: '/legalNotice/terms' },
      { label: 'Politique de confidentialité', path: '/legalNotice/privacy' },
